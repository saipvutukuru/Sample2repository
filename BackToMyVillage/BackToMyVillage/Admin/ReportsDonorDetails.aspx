<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="ReportsDonorDetails.aspx.cs" Inherits="Admin_ReportsPayments" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <div id="divContent">
        <span class="style5" style="color: #000000">Report For Registered Donors</span> 
