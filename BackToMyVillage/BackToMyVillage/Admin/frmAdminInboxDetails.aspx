<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="frmAdminInboxDetails.aspx.cs" Inherits="Admin_frmAdminInboxDetails" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="panel1" runat="server">
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            <tr>
                <td bgcolor=" style="background-color: #173D15" 
                    style="background-color: #C0C0C0">
                    <br style="background-color: #173D15" />
                    <center class="style5" style="color: #000000">
                        &nbsp;InBox Details
                    </center>
                </td>
            </tr>
