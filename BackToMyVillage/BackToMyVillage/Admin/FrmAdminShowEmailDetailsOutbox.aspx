<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="FrmAdminShowEmailDetailsOutbox.aspx.cs" Inherits="Admin_FrmAdminShowEmailDetailsOutbox" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            <tr>
                <td bgcolor="#E7B642" style="background-color: #C0C0C0">
                    <br />
                    <center class="style5">
                        Show Details
                    </center>
