<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="frmAdminOutbox.aspx.cs" Inherits="Admin_frmAdminOutbox" Title="Untitled Page" %>
  ...
  <asp:UpdatePanel ID="panel1" runat="server">
       ...
       <asp:Panel ID="mainPanel" runat="server">
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            <tr>
                <td bgcolor="Silver" style="background-color:Silver">
                    <br />
                    <center class="style5">
...
<ControlStyle Width="25%"></ControlStyle>
            ...
            <tr>
                <td>
                    <center>
                        <asp:Label ID="lblMsg" runat="server" Visible="False" ForeColor="Black"></asp:Label></center>
                </td>
            </tr>
            <tr>
                <td bgcolor="#E7B642" style="background-color:Silver">
                    <br />
                </td>
            </tr>
        </table>
