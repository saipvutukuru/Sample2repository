<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="frmAdminComposeMails.aspx.cs" Inherits="Admin_frmAdminComposeMails" Title="Untitled Page" %>
...
<asp:ScriptManager ID="srmgr" runat ="server">
</asp:ScriptManager>
...
<center>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <tr>
                <td>
                    <center>
                        <asp:Label ID="lblMsg" runat="server" ForeColor="white"></asp:Label></center>
                </td>
            </tr>
            <tr>
                <td bgcolor="#E7B642" style="background-color: #E1FFFF; color: #000000;">
                    <br />
                </td>
            </tr>
        </table>
