        ...
        <table align="center">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="ddlVillagename" runat="server" Height="26px" 
                        Width="190px">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:DropDownList ID="ddlAcitivityName" runat="server" Height="25px" 
                        Width="190px">
                    </asp:DropDownList>
                </td>
                <td style="text-align: left">
            ...
            <tr>
                <td colspan="3" class="style6">
                    <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click" 
                        PostBackUrl="~/Volunteers/frmActivityMonitoeingDetails.aspx" 
                        Font-Size="Smaller">Click Here To 
