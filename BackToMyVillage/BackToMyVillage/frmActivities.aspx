<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmActivities.aspx.cs" Inherits="frmActivities" Title="Untitled Page" %>
...
<center>
    <asp:GridView ID="grdActivities" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource1" Width="343px" ForeColor="Black">
        <Columns>
